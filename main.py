...
_SESS_DIR = _pathlib.Path("/tmp/procdna_sessions")
_SESS_DIR.mkdir(parents=True, exist_ok=True)

def _sess_path(sid: str) -> _pathlib.Path:
...
import pickle as _pickle, pathlib as _pathlib

_CACHE_DIR = _pathlib.Path("/tmp/procdna_cache")
_CACHE_DIR.mkdir(parents=True, exist_ok=True)

def _cache_path(parse_id: str) -> _pathlib.Path:
